...
public class LibraryController {
    ...
    public ResponseEntity<BookResponse> updateBook(@PathVariable("bookId") Long bookId, @RequestBody BookRequest bookRequest) {
    ...
    public ResponseEntity<LoanResponse> getLoan(@PathVariable("bookId") Long loanId) {
    ...
    public ResponseEntity<LoanResponse> returnLoan(@PathVariable("bookId") Long loanId, @RequestBody LoanRequest loanRequest) {
