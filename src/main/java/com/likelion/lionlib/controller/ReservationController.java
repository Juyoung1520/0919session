...
public class ReservationController {
    ...
    public ResponseEntity<List<ReservationResponse>> getReservationsByMemberId(@PathVariable("memberId") Long memberId) {
    ...
    public ResponseEntity<Map<String, Long>> getReservationCountByBookId(@PathVariable("bookId") Long bookId) {
        log.info("Request GET reservation count for book with ID: {}", bookId);
        Map<String, Long> response = reservationService.getReservationCountByBookId(bookId);
