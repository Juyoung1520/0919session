...
import com.likelion.lionlib.dto.MemberResponse; // Member 정보를 반환할 DTO를 만드세요.import com.likelion.lionlib.service.MemberService;
...
public class MemberController {
    ...
    public ResponseEntity<MemberResponse> getMemberById(@PathVariable("memberId") Long memberId) {
        ...
        log.info("Response GET member: {}", memberResponse);
